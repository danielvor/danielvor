  ...
  return (
    <SectionContainer id="about" title="Sobre mim">
      <div className="flex items-center justify-between md:justify-center">
        ...
        >
          <p>
          Sou um desenvolvedor Back-End com experiência em projetos acadêmicos e pessoais, 
          focado no desenvolvimento de APIs.
          </p>

          <p>
          Atualmente, trabalho como Analista de Fraude e Risco.
          Paralelamente, desenvolvo projetos que me permitem aplicar e aprimorar meus conhecimentos em desenvolvimento de software. 
          </p>
